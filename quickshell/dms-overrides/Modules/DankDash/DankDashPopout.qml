            ...
            Column {
                ...
                Item {
                    ...
                    implicitHeight: {
                        ...
                        if (root.currentTabId === "notes")
                            return notesLoader.item?.implicitHeight ?? 460;
                        return 410;
                    }
                    ...
                    DankSpinner {
                        ...
                        size: 40
                        visible: (wallpaperLoader.active && wallpaperLoader.status === Loader.Loading) || (mediaLoader.active && mediaLoader.status === Loader.Loading) || (weatherLoader.active && weatherLoader.status === Loader.Loading) || (notesLoader.active && notesLoader.status === Loader.Loading)
                    }
                    ...
                    Loader {
                        id: notesLoader
                        anchors.fill: parent
                        active: root.currentTabId === "notes"
                        visible: active
                        asynchronous: true
                        sourceComponent: Component {
                            NotesKanbanTab {}
